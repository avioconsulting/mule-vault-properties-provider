...
public class VaultPrefixPathDepthTestCase extends MuleArtifactFunctionalTestCase {
  @Rule
  ...
  protected String getConfigFile() {
    ...
    mockClient
        ...
        .when(
            request()
                .withMethod("GET")
                .withPath("/v1/avio/dev/kv/data/test/mysecret"))
        .respond(
            response()
                .withStatusCode(200)
    ...
    return "mule_config/test-mule-prefix-path-depth-config.xml";
  }
