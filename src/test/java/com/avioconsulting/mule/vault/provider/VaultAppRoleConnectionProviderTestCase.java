...
public class VaultAppRoleConnectionProviderTestCase extends MuleArtifactFunctionalTestCase {
  ...
  protected String getConfigFile() {
    // Set vaultUrl and vault roleid and secretid properties so they can be used in
