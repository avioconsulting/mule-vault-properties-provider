...
public class VaultEc2MetadataConnectionProviderTestCase extends MuleArtifactFunctionalTestCase {
  ...
  protected String getConfigFile() {
    ...
    System.setProperty("INSTANCE_PKCS7_URI",
        String.format("http://%s:%d/latest/dynamic/instance-identity/pkcs7",
            mockServerRule.getClient().remoteAddress().getHostString(),
            mockServerRule.getClient().remoteAddress().getPort()));
    mockClient
        .withSecure(false)
        .when(
    ...
    mockClient
        ...
        .respond(
            response()
                ...
                .withBody(
                    "{\"lease_id\":\"\",\"renewable\":false,\"data\":null,\"auth\":{\"client_token\":\"MOCK_TOKEN\",\"accessor\":\"18bb8f89-826a-56ee-c65b-1736dc5ea27d\",\"policies\":[\"web\",\"stage\"],\"lease_duration\":3600,\"renewable\":true}}"));
    mockClient
        .withSecure(true)
        .when(
            request()
        ...
        .respond(
            response()
                ...
                .withHeader("Content-Type", "application/json")
                .withBody(
                    "{\"request_id\": \"69411f4b-fb02-171a-f66c-485f106e7f5c\",\"lease_id\": \"\",\"renewable\": false,\"lease_duration\": 0,\"data\": {\"data\": {\"att1\": \"test_value1\",\"att2\": \"test_value2\"},\"metadata\": {\"created_time\": \"2019-04-24T23:03:18.63231658Z\",\"deletion_time\": \"\",\"destroyed\": false,\"version\": 1}},\"wrap_info\": null,\"warnings\": null,\"auth\": null}")
