...
public class TrustStoreConfig {
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass())
      return false;
    TrustStoreConfig that = (TrustStoreConfig) o;
    return insecure == that.insecure && type.equals(that.type) && path.equals(that.path)
        && Objects.equals(password, that.password);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, path, password, insecure);
  }
}
