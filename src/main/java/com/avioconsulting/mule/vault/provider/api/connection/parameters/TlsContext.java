...
public class TlsContext {
  ...
  public TlsContext(ConfigurationParameters parameters) {
    ...
    if (tlsContextList.size() > 0) {
      ...
      List<ConfigurationParameters> trustStoreParams = tlsParameters.getComplexConfigurationParameter(
          builder().namespace(EXTENSION_NAMESPACE).name("trust-store").build());
      ...
      List<ConfigurationParameters> keyStoreParams = tlsParameters.getComplexConfigurationParameter(
          builder().namespace(EXTENSION_NAMESPACE).name("key-store").build());
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(trustStoreConfig, that.trustStoreConfig)
        && Objects.equals(keyStoreConfig, that.keyStoreConfig);
  }
